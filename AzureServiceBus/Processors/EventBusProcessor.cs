...
namespace AzureServiceBus.Processors
{
    public class EventBusProcessor : IEventBusProcessor
    {
            ...
            string topicName, string subscriptionClientName)
        {
            ...
            _processor =
                serviceBusPersistenceConnection.TopicClient.CreateProcessor(topicName, subscriptionClientName, options);
        }
        ...
        private async Task ProcessMessageAsync(ProcessMessageEventArgs args)
        {
            ...
            if (await ProcessEventAsync(eventName, messageData))
            {
                ...
                _logger.LogInformation("Processed the message");
            }
        }
